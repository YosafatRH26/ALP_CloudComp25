<x-app-layout>
    <div class="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100 relative overflow-hidden">
        ...
        <div class="max-w-3xl mx-auto py-16 px-4 sm:px-6 lg:px-8 relative">
            ...
            <form
                    ...
                    <label for="cv-upload" class="block group-hover:cursor-pointer">
                        <div id="drop-zone" class="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-slate-700 rounded-3xl bg-slate-900/40 backdrop-blur-sm transition-all duration-300 hover:border-sky-500/50 hover:bg-slate-900/60 group-hover:shadow-lg group-hover:shadow-sky-500/5">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="text-xs text-slate-500 uppercase tracking-widest">Maksimal 2MB (Hanya PDF)</p>
                            </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <select name="language" required 
                                class="w-full appearance-none rounded-2xl bg-slate-900/80 border border-slate-700 px-4 py-3 text-sm focus:border-sky-500 focus:ring-sky-500 transition-all">
                                <option value="id">🇮🇩 Bahasa Indonesia</option>
                                <option value="en">🇺🇸 English</option>
                            </select>
                            <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-4 text-slate-500">
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
                            </div>
                        </div>
                    </div>
                ...
                <button
                    type="submit"
                    class="w-full py-4 px-6 rounded-2xl bg-sky-600 hover:bg-sky-500 text-white font-bold text-sm shadow-xl shadow-sky-900/20 transition-all transform active:scale-[0.98] flex items-center justify-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                    Mulai Analyze Sekarang
                </button>
            </form>
        </div>
    </div>
    ...
    <div id="loading-overlay" class="fixed inset-0 z-[100] hidden items-center justify-center bg-slate-950/90 backdrop-blur-md transition-opacity duration-300">
        <div class="flex flex-col items-center max-w-xs text-center">
            ...
            <p class="text-slate-400 text-sm leading-relaxed" id="loading-text">
