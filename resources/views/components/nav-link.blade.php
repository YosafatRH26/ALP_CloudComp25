...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-sky-400 text-sm font-medium leading-5 text-sky-400 focus:outline-none focus:border-sky-500 transition duration-150 ease-in-out'
